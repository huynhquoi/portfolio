        ...
        <section id="projects" className="py-20">
            <div className="container mx-auto px-4">
                ...
                <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
                    Đây là một số projects mà tôi đã build. Mỗi project đều reflect passion
                    và technical skills của tôi.
                </p>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    {filteredProjects.map((project) => (
                        <div key={project.id} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                            <Image
                                width={200}
                                height={200}
                                src={project.image}
